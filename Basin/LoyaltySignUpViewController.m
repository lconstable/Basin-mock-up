...
#import "LoyaltySignUpViewController.h"
#import <QuartzCore/QuartzCore.h>

@interface LoyaltySignUpViewController ()

@end

@implementation LoyaltySignUpViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    legalTextView.font = [UIFont fontWithName:@"ProximaNova-Regular" size:12];
...
- (void)viewDidUnload {
    ...
    [self setLegalTextView:nil];
    [super viewDidUnload];
}

#pragma mark Button Actions & UIAlertView
- (IBAction)signUpPressed:(id)sender
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Congratulations!"
                                                    message:@"You are now a part of the loyalty program! Major sales & events will sync to your calendar."
                                                   delegate:self
...
//  Not starting w/ keyboard up in order to make legal information visible
